...
#####################
library(igraph)
t <- graph_from_literal(animale-+cane:gatto:topo, gatto-+british:persiano,
                         gatto-+retriever,
...
fit <- vglm(y~x, family = multinomial(refLevel = "cocker"),
            data = train)
...
t3 <- graph_from_literal(animale-+cane:gatto, gatto-+british:persiano,
                         gatto-+retriever,
                         cane-+cocker:retriever, retriever-+golden:labrador)
